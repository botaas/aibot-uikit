...
export type QueryChannelsAPIResponse<
  OneChatGenerics extends ExtendableGenerics = DefaultGenerics
> = APIResponse & {
  channels: Omit<ChannelAPIResponse<OneChatGenerics>, keyof APIResponse>[];
};

export type QueryChannelAPIResponse<
  OneChatGenerics extends ExtendableGenerics = DefaultGenerics
> = APIResponse & ChannelAPIResponse<OneChatGenerics>;
...
export type GetCommandResponse<
  OneChatGenerics extends ExtendableGenerics = DefaultGenerics
> = APIResponse & CreateCommandOptions<OneChatGenerics> & CreatedAtUpdatedAt;
...
export type UpdateChannelOptions<
  OneChatGenerics extends ExtendableGenerics = DefaultGenerics
> = Omit<CreateChannelOptions<OneChatGenerics>, 'name'> & {
  created_at?: string;
  updated_at?: string;
};
...
export type SearchMessageSortBase<
  OneChatGenerics extends ExtendableGenerics = DefaultGenerics
> = Sort<OneChatGenerics['messageType']> & {
  attachments?: AscDesc;
