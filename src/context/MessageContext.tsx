...
> = {
   ...
   * Please check [Message](https://github.com/botaas/aibot-uikit/blob/master/src/components/Message.tsx) component for default implementation.
   */
  ...
  handleRetry: ChannelActionContextValue<OneChatGenerics>['retrySendMessage'];
  ...
  /** Array of muted users coming from [ChannelStateContext](https://openbot.chat/chat/docs/sdk/react/contexts/channel_state_context/#mutes) */
  ...
  /** Custom function to render message text content, defaults to the renderText function: [utils](https://github.com/botaas/aibot-uikit/blob/master/src/utils.tsx) */
  renderText?: (
    text?: string,
...
>(
  ...
  if (!contextValue) {
    ...
    return {} as MessageContextValue<OneChatGenerics>;
  }

  return (contextValue as unknown) as MessageContextValue<OneChatGenerics>;
};
...
>(
  ...
  const WithMessageContextComponent = (
    props: Omit<P, keyof MessageContextValue<OneChatGenerics>>,
  ) => {
    const messageContext = useMessageContext<OneChatGenerics>();
