...
> = Omit<ChannelStateContextValue<OneChatGenerics>, 'members' | 'mutes' | 'watchers'> &
  MessageListProps<OneChatGenerics>;

const MessageListWithContext = <
  OneChatGenerics extends DefaultOneChatGenerics = DefaultOneChatGenerics
>(
  props: MessageListWithContextProps<OneChatGenerics>,
) => {
  const {
    channel,
  ...
  const { customClasses } = useChatContext<OneChatGenerics>('MessageList');
  ...
  } = useComponentContext<OneChatGenerics>('MessageList');
...
export type MessageListProps<
  OneChatGenerics extends DefaultOneChatGenerics = DefaultOneChatGenerics
> = Partial<Pick<MessageProps<OneChatGenerics>, PropsDrilledToMessage>> & {
  ...
  /** Overrides the default props passed to [InfiniteScroll](https://github.com/botaas/aibot-uikit/blob/master/src/components/InfiniteScrollPaginator/InfiniteScroll.tsx) */
  ...
  /** Function called when newer messages are to be loaded, defaults to function stored in [ChannelActionContext](https://openbot.chat/chat/docs/sdk/react/contexts/channel_action_context/) */
  loadMoreNewer?: ChannelActionContextValue['loadMoreNewer'] | (() => Promise<void>);
  /** The limit to use when paginating messages */
  messageLimit?: number;
  /** The messages to render in the list, defaults to messages stored in [ChannelStateContext](https://openbot.chat/chat/docs/sdk/react/contexts/channel_state_context/) */
...
>(
  ...
  } = useChannelStateContext<OneChatGenerics>('MessageList');

  return (
    <MessageListWithContext<OneChatGenerics>
