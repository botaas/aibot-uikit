...
export const areMessagePropsEqual = <
  OneChatGenerics extends DefaultOneChatGenerics = DefaultOneChatGenerics
>(
  prevProps: MessageProps<OneChatGenerics> & {
    mutes?: Mute<OneChatGenerics>[];
    showDetailedReactions?: boolean;
  },
  nextProps: MessageProps<OneChatGenerics> & {
    mutes?: Mute<OneChatGenerics>[];
    showDetailedReactions?: boolean;
  },
) => {
...
export const areMessageUIPropsEqual = <
  OneChatGenerics extends DefaultOneChatGenerics = DefaultOneChatGenerics
>(
  prevProps: MessageContextValue<OneChatGenerics> & {
    showDetailedReactions?: boolean;
  },
  nextProps: MessageContextValue<OneChatGenerics> & {
    showDetailedReactions?: boolean;
  },
) => {
