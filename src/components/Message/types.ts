...
> = {
  ...
  customMessageActions?: MessageContextValue<OneChatGenerics>['customMessageActions'];
  ...
  /** UI component to display a Message in MessageList, overrides value in [ComponentContext](https://openbot.chat/chat/docs/sdk/react/contexts/component_context/#message) */
  ...
  /** Custom mention click handler to override default in [ChannelActionContext](https://openbot.chat/chat/docs/sdk/react/contexts/channel_action_context/) */
  onMentionsClick?: ChannelActionContextValue<OneChatGenerics>['onMentionsClick'];
  /** Custom mention hover handler to override default in [ChannelActionContext](https://openbot.chat/chat/docs/sdk/react/contexts/channel_action_context/) */
  onMentionsHover?: ChannelActionContextValue<OneChatGenerics>['onMentionsHover'];
  /** Custom function to run on user avatar click */
  onUserClick?: UserEventHandler<OneChatGenerics>;
  /** Custom function to run on user avatar hover */
  onUserHover?: UserEventHandler<OneChatGenerics>;
  /** Custom open thread handler to override default in [ChannelActionContext](https://openbot.chat/chat/docs/sdk/react/contexts/channel_action_context/) */
  openThread?: ChannelActionContextValue<OneChatGenerics>['openThread'];
  /** @deprecated in favor of `channelCapabilities - The user roles allowed to pin messages in various channel types */
  pinPermissions?: PinPermissions;
  /** A list of users that have read this Message */
  readBy?: UserResponse<OneChatGenerics>[];
  /** Custom function to render message text content, defaults to the renderText function: [utils](https://github.com/botaas/aibot-uikit/blob/master/src/utils.ts) */
  renderText?: (
    text?: string,
...
export type MessageUIComponentProps<
  OneChatGenerics extends DefaultOneChatGenerics = DefaultOneChatGenerics
> = Partial<MessageContextValue<OneChatGenerics>>;
