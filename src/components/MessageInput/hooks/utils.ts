...
> = {
  ...
  query: string;
  text: string;
  users: UserResponse<OneChatGenerics>[];
...
export const searchLocalUsers = <
  OneChatGenerics extends DefaultOneChatGenerics = DefaultOneChatGenerics
>(
  params: SearchLocalUserParams<OneChatGenerics>,
...
type CheckUploadPermissionsParams<
  OneChatGenerics extends DefaultOneChatGenerics = DefaultOneChatGenerics
> = {
  addNotification: ChannelActionContextValue<OneChatGenerics>['addNotification'];
  file: ImageUpload['file'];
  getAppSettings: ChatContextValue<OneChatGenerics>['getAppSettings'];
...
export const checkUploadPermissions = async <
  OneChatGenerics extends DefaultOneChatGenerics = DefaultOneChatGenerics
>(
  params: CheckUploadPermissionsParams<OneChatGenerics>,
) => {
  const { addNotification, file, getAppSettings, t, uploadType } = params;

  let appSettings: AppSettingsAPIResponse<OneChatGenerics> | null = null;
